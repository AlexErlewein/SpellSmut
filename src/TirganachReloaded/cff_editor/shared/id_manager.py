...
class IDManager:
    ...
    def get_next_id(self, content_type: ContentType) -> int:
        ...
        for candidate_id in range(start, end + 1):
            if candidate_id not in self.allocated_ids.get(content_type, set()):
                return candidate_id
    ...
    def release_id(self, content_type: ContentType, item_id: int):
        ...
        if content_type in self.allocated_ids and item_id in self.allocated_ids[content_type]:
    ...
    def is_id_used(self, content_type: ContentType, item_id: int) -> bool:
        ...
        return item_id in self.allocated_ids.get(content_type, set())
    ...
    def get_stats(self) -> Dict[str, Dict[str, int]]:
        ...
        for content_type in ContentType:
            ...
            used = len(self.allocated_ids.get(content_type, set()))
