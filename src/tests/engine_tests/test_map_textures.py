#!/usr/bin/env python3
"""
Test script to verify enhanced map loader with texture assignment parsing
"""
...
def test_map_loading_with_textures():
    """Test loading a map with texture assignment parsing"""
    print("🧪 Testing Enhanced Map Loader with Texture Assignment Parsing")
    print("=" * 60)
...
if __name__ == "__main__":
    success = test_map_loading_with_textures()
