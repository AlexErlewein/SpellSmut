...
-- Source: C:\project\main\mission\dialoge\p210\n9377_ZerbitengeistRaum2.txt
	...
	OnBeginDialog{
		...
		Actions = {
			Say{Tag = "zerbiteghostroom2P210_036", String = "Ihr kehrt zr�ck?"},
	...
	OnAnswer{2;
		...
		Actions = {
			Say{Tag = "zerbiteghostroom2P210_003", String = "Seid Ihr gekommen, um uns zu verh�hnen? Wollt Ihr das Werk vollenden, das Hokan einst begonnen hat?"},
	...
	OnAnswer{3;
		...
		Actions = {
			Say{Tag = "zerbiteghostroom2P210_004", String = "Wir Geister k�nnen Euch keinen Schaden mehr zuf�gen, aber die Fallen, die wir einst errichtet haben, werden Euer Untergang sein!"},
	...
	OnAnswer{5;
		...
		Actions = {
			...
			OfferAnswer{Tag = "zerbiteghostroom2P210_014PC", String = "Erz�hlt mir von Anktahr.", AnswerId = 17, Color = ColorDarkOrange},
			OfferAnswer{Tag = "zerbiteghostroom2P210_020PC", String = "Erz�hlt mir von den Fallen.", AnswerId = 24, Color = ColorDarkOrange},
	...
	OnAnswer{12;
		...
		Actions = {
			Say{Tag = "zerbiteghostroom2P210_010", String = "Wir haben einst hier gelebt Runenkrieger! Als Mitglieder des Zerbitenordens erforschten wir die Geheimnisse des schwarzen Dschungels .. und bewahrten das Reich vor seinem �bel."},
	...
	OnAnswer{14;
		...
		Actions = {
			Say{Tag = "zerbiteghostroom2P210_012", String = "Wir konnten ihm nichts entgegensetzen! Schlie�lich beschlossen wir, unsere Festungen in t�dliche Fallen zu verwandeln, damit Hokan auf seiner Suche nach unserem Wissen sein Ende finden sollte!"},
	...
	OnAnswer{15;
		...
		Actions = {
			Say{Tag = "zerbiteghostroom2P210_013", String = "Aber er ahnte die Gefahr! Er griff nicht an, sondern belagerte unsere Festungen und lie� uns verhungern wie Tiere! So sind diese Hallen heute nur noch unser Grab."},
			Answer{Tag = "", String = "", AnswerId = 5},
		)}
	...
	OnAnswer{18;
		...
		Actions = {
			Say{Tag = "zerbiteghostroom2P210_015", String = "Bevor er Hokan in die H�nde gefallen ist, h�tte er Euch vernichtet! Nun ist er nur noch ein Schatten seiner selbst!"},
			Answer{Tag = "", String = "", AnswerId = 5},
		)}
	...
	OnAnswer{18;
		...
		Actions = {
			Say{Tag = "zerbiteghostroom2P210_016", String = "Er war unser F�hrer, unser Grossmeister! Der Weiseste und G�tigste aus unserer Mitte!"},
	...
	OnAnswer{21;
		...
		Actions = {
			Say{Tag = "zerbiteghostroom2P210_018", String = "Er opferte sich, damit Hokan nicht unser geheimstes Wissen in die H�nde fiel! Zur Strafe hat Hokan seine Seele versklavt und schlie�lich an die Rune gebunden!"},
	...
	OnAnswer{22;
		...
		Actions = {
			Say{Tag = "zerbiteghostroom2P210_019", String = "So hat er den einzigen, der ihn jemals �berlisten konnte zu seinem willigen Sklaven gemacht! Welch grausamer Spott! Aber jetzt ist er frei!"},
			Answer{Tag = "", String = "", AnswerId = 5},
		)}
	...
	OnAnswer{25;
		...
		Actions = {
			Say{Tag = "zerbiteghostroom2P210_021", String = "Ihr werdet ihre Wirkung noch fr�h genug am eigenen Leib erfahren!"},
			Answer{Tag = "", String = "", AnswerId = 5},
		)}
	...
	OnAnswer{25;
		...
		Actions = {
			Say{Tag = "zerbiteghostroom2P210_022", String = "Sie sind mechanish aber auch magisch! Wir haben sie so gebaut, dass ein geduldiger Mensch, der aus Fehlern lernt, sie �berwinden kann."},
	...
	OnAnswer{27;
		...
		Actions = {
			Say{Tag = "zerbiteghostroom2P210_023", String = "Aber ein Wahnsinniger wie Hokan h�tte nur versucht, sich mit Gewalt Zutritt zu verschaffen! Das w�re sein Ende gewesen!"},
	...
	OnAnswer{28;
		...
		Actions = {
			Say{Tag = "zerbiteghostroom2P210_024", String = "Achtet also auf die Hinweise, die �berall zu finden sind, dann werdet Ihr diesen Ort lebend verlassen!"},
			Answer{Tag = "", String = "", AnswerId = 5},
		)}
	...
	OnAnswer{31;
		...
		Actions = {
			Say{Tag = "zerbiteghostroom2P210_027", String = "Das Szepter liegt in der Schatzkammern nord�stlich von hier!"},
	...
	OnAnswer{33;
		...
		Actions = {
			Say{Tag = "zerbiteghostroom2P210_028", String = "Merkt Euch das: Um dorthin vorzudringen, m�sst ihr die f�nf steinernen K�pfe zum Leuchten bringen!"},
			Answer{Tag = "", String = "", AnswerId = 5},
		)}
	...
	OnAnswer{36;
		...
		Actions = {
			Say{Tag = "zerbiteghostroom2P210_031", String = "Nehmt diese drei M�nzen als Dank! Nun ist Anktahr endlich nach Hause zur�ckgekehrt. Wir werden seinen gepeinigten Geist heilen."},
	...
	OnAnswer{38;
		...
		Actions = {
			SetGlobalFlagTrue{Name = "g_P210_RuneAnktharReturned"},
					...
					TransferItem{GiveItem = 7356 , Flag = Give},
			Say{Tag = "zerbiteghostroom2P210_032", String = "Ihr habt uns einen gro�en Dienst erwiesen! Wie k�nnen nun wir Euch helfen?"},
	...
	OnAnswer{41;
		...
		Actions = {
			Say{Tag = "zerbiteghostroom2P210_035", String = "Ihr m�sst wissen: Demjenigen, der alle Artefakte findet, gew�hren wir Zugang zu unserem Verm�chtnis."},
