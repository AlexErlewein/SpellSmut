...
--- 4: Das Spiel l�uft! Zerbos Zug!
--- 5: Das Spiel l�uft! Spielers Zug!
--- 6: Jetzt wird gek�mpft bis einer stirbt
--- 7: Nach der Runde ist vor der Runde. Alle Werte zur�cksetzen.
...
--- 12: Die Arena wird ausgefegt, Blut und Ged�rm mit dicken Schl�uchen weggesp�lt
...
Respawn
{
	...
	Actions =
	{
		RandomizeGlobalCounter{Name = "g_P202_ZerbosNextChoice", MaxValue = 4}, -- der n�chste Zug wird immer
...
OnEvent
{
	...
	Actions =
	{
		Outcry {NpcId = 10807, String = "Ich spiele den Torw�chter!", Tag = "oca2zerboP202_005"},
...
OnEvent
{
	...
	Actions =
	{
		Outcry {NpcId = 10807, String = "F�nf Runden sind vorbei. Nun beginnt das Endspiel!", Tag = "oca2zerboP202_008"},
...
-- Source: C:\project\main\mission\dialoge\P202\n10807_Zerbo.txt
	...
	OnAnswer{2;
		...
		Actions = {
			Say{Tag = "zerboP202_003", String = "Hm, schade, Ihr habt verloren. Vielleicht habt Ihr das n�chste mal mehr Gl�ck? Lasst uns doch noch eine Partie wagen?"},
	...
	OnAnswer{2;
		...
		Actions = {
			Say{Tag = "zerboP202_001", String = "Gratulation! Ihr habt gesiegt! Ah, wie herrlich gegen einen w�rdigen Gegner zu spielen!"},
	...
	OnAnswer{3;
		...
		Actions = {
			Say{Tag = "zerboP202_002", String = "Daf�r sollt Ihr reich belohnt werden! Nehmt dies!"},
	...
	OnAnswer{10;
		...
		Actions = {
			Say{Tag = "zerboP202_005", String = "Ah! Ihr interessiert Euch f�r das Hadeko-Spiel? Eine gute Wahl!"},
	...
	OnAnswer{11;
		...
		Actions = {
			Say{Tag = "zerboP202_007", String = "Seit Generationen warte ich darauf, endlich einmal wieder eine Partie Hadeko zu spielen! Diese Kreaturen hier sind einfach zu ... humorlos daf�r!"},
			Answer{Tag = "zerboP202_008PC", String = "Ich habe keine Zeit f�r Spiele!", AnswerId = 12},
		)}
	...
	OnAnswer{23;
		...
		Actions = {
			Say{Tag = "zerboP202_015", String = "Das Spiel ist f�r zwei Spieler gemacht. Jeder Spieler hat sechs Figuren, die auf dem Spielbrett gegeneinander k�mpfen."},
	...
	OnAnswer{24;
		...
		Actions = {
			Say{Tag = "zerboP202_016", String = "Zuerst werden f�nf Zweik�mpfe ausgefochten, bei denen der Herausforderer eine Figur aufstellt und der andere Spieler einen K�mpfer dagegen schickt."},
	...
	OnAnswer{25;
		...
		Actions = {
			Say{Tag = "zerboP202_017", String = "Nachdem die f�nf Zweik�mpfe ausgefochten sind, werden alle �berlebenden Figuren in einem Endkampf gegeneinander geschickt. Wer zuerst alle Figuren verliert hat auch das Spiel verloren!"},
	...
	OnAnswer{26;
		...
		Actions = {
			Say{Tag = "zerboP202_018", String = "Die Figuren sind der Held, der Trickster, der Mentor, der Torw�chter, der Schatten und der Erzmagier. Jede Figur hat St�rken und Schw�chen, die Ihr erlernen m�sst."},
	...
	OnAnswer{28;
		...
		Actions = {
			Say{Tag = "zerboP202_020", String = "Der Held t�tet jeden im Zweikampf, scheidet dadurch aber selbst aus!"},
	...
	OnAnswer{29;
		...
		Actions = {
			Say{Tag = "zerboP202_021", String = "Der Trickster ist launisch! Er kann schwach und stark erscheinen! Ist er schwach, verliert er gegen die anderen, ist er aber stark gewinnt er gegen alle! nur der Held kann ihn dann noch t�ten!"},
	...
	OnAnswer{30;
		...
		Actions = {
			Say{Tag = "zerboP202_022", String = "An diesem Spielbrett bin ich der Herausforderer, ich stelle also eine K�mpfer auf und Ihr k�nnt am Hadeko-Spieltisch entscheiden, welche Figur Ihr der meinen entgegen setzen wollt."},
	...
	OnAnswer{31;
		...
		Actions = {
			Say{Tag = "zerboP202_023", String = "Nach f�nf Zweik�mpfen beginnt der Endkampf! Wer dann noch siegrech bleibt, hat gewonnen!"},
	...
	OnAnswer{32;
		...
		Actions = {
			Say{Tag = "zerboP202_024", String = "Ach ja ... nat�rlich m�sst Ihr erst einmal alle sechs Figuren haben, bevor Ihr spielen k�nnt! Es sind kleine Puppen, Ihr erkennt sie an ihrer wundervollen Detailtreue!"},
	...
	OnAnswer{36;
		...
		Actions = {
			Say{Tag = "zerboP202_026", String = "Ihr habt nicht alle sechs Hadeko Puppen! So k�nnen wir nicht spielen!"},
	...
	OnAnswer{39;
		...
		Actions = {
			Say{Tag = "zerboP202_029", String = "Nun zeigt, ob Ihr auch zu spielen wi�t! Die Partie beginnt!"},
