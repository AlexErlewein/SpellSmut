...
CreateCutScene
{
	...
	TimedActions =
	{
		...
		[45] =
		{
			LookAtFigure {Target = 10286, NpcId = 0}, --Avatar f�hrt herum
		},
		[50] =
		{
			LookAtFigure {Target = 10286, NpcId = 0}, --Avatar f�hrt herum
		...
		[80] =
		{
			...
			LookAtFigure {Target = 10286, NpcId = 0}, 
			LookAtFigure {Target = 0, NpcId = 10286}, 
			CutSceneSay {Tag = "csa242phoenixguard_003", NpcId = 10286, String = "Ein Freund! Jenquai sagte mir, dass ich Euch hier finden werde, Gef�hrte der Rune."},
		...
		[90] =
		{
			...
			LookAtFigure {Target = 10286, NpcId = 0}, 
			LookAtFigure {Target = 0, NpcId = 10286}, 
			CutSceneSay {Tag = "csa242avatar_004", NpcId = 0, String = "Dann seid Ihr der Runenkrieger, der den Ph�nixstein bewacht? Kommt Ihr endlich, um das aufzuhalten, was Ihr begonnen habt?"},
		},
		...
		[100] =
		{
			--8sek
			WaitForEndOfSpeech,	 --sollte immer angegeben werden
			ExecuteCameraScript{Script = n32532_CameraAuftretenPhoenixII},	--Kamera f�hrt an Phoenixkrieger heran
			LookAtFigure {Target = 10286, NpcId = 0}, 
			LookAtFigure {Target = 0, NpcId = 10286}, 
		...
		[125] =
		{
			Goto {X = 225, Y = 137, NpcId = 10286, Range = 0, WalkMode = Walk, GotoMode = GotoNormal, XRand = 0, YRand = 0}, --Ph�nix n�her an Avatar
			LookAtFigure {Target = 10286, NpcId = 0}, 
			LookAtFigure {Target = 0, NpcId = 10286}, 
		},
		...
		[150] =
		{
			ExecuteCameraScript{Script = n32532_CameraAuftretenPhoenixIII},	--Kamera noch n�her
			LookAtFigure {Target = 10286, NpcId = 0}, 
			LookAtFigure {Target = 0, NpcId = 10286}, 
		},
		...
		[230] =
		{
			...
			LookAtFigure {Target = 10286, NpcId = 0}, 
			LookAtFigure {Target = 0, NpcId = 10286}, 
			CutSceneSay {Tag = "csa242phoenixguard_008", NpcId = 10286, String = "Ich will den Zirkel f�r seine Taten richten! Endg�ltig!"},
		},
		...
		[270] =
		{
			...
			CutSceneSay {Tag = "csa242avatar_009", NpcId = 0, String = "Dann lasst uns gemeinsam die Scharfrichter sein, W�chter des Ph�nix! Kommt, sie warten bereits auf uns!"},
			LookAtFigure {Target = 10286, NpcId = 0}, 
			LookAtFigure {Target = 0, NpcId = 10286}, 
		},
		...
		[320] =
		{
			Goto {X = 220, Y = 125, NpcId = 0, Range = 0, WalkMode = Run, GotoMode = GotoNormal, XRand = 0, YRand = 0}, --Avatar ein st�ck in die Ebene
		},
		[330] =
		{
			Goto {X = 219, Y = 125, NpcId = 10286, Range = 0, WalkMode = Run, GotoMode = GotoNormal, XRand = 0, YRand = 0}, --Avatar ein st�ck in die Ebene
		},
