...
int __thiscall shield_wall_universal_refresh_handler(SF_CGdSpell *_this, uint16_t spell_index) // we casted shieldwall universal again before the previous expired
{
    SF_GdSpell *spell = &_this->active_spell_list[spell_index];
