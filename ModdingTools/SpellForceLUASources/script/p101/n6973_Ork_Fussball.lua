...
--wenn alle auf Position, dann Startschu
OnEvent
{
	NotInDialog = FALSE,
	Conditions = 
...
OnToggleEvent
{
	...
	OffConditions = 
	{
		ODER(		IsGlobalCounter {Name = "P101CounterGoblinPunkte", Value = 4, Operator = IsEqual, UpdateInterval = 10},
	...
	OffActions = 
	{
		...
		Goto {X = 221, Y = 225, NpcId = 7758, Range = 0, WalkMode = Walk , GotoMode = GotoForced}, --Goblin zurck Mitte
		 
	},
}


--nach Startschu, Goblin zu Base1
OnEvent
{
	NotInDialog = FALSE ,
	Conditions = 
...
OnEvent
{
	...
	Actions = 
	{
		...
		SetEffect{Effect = "Lightning", Length = 200 , TargetType = World , X = 216, Y = 212},	--Punkt fr Goblin-Effekt
...
OnEvent
{
	...
	Actions = 
	{
		...
		SetEffect{Effect = "Lightning", Length = 200 , TargetType = World , X = 225, Y = 239},	 --Punkt fr Goblin-Effekt
		IncreaseGlobalCounter{ Name = "P101CounterGoblinPunkte", Step = 1},
...
OnEvent
{
	...
	Actions = 
	{
		...
		SetEffect{Effect = "Lightning", Length = 200 , TargetType = World , X = 207, Y = 221},	 --Punkt fr Goblin-Effekt
		IncreaseGlobalCounter{ Name = "P101CounterGoblinPunkte", Step = 1},
...
OnEvent
{
	...
	Actions = 
	{
		SetEffect{Effect = "Lightning", Length = 200 , TargetType = World , X = 235, Y = 230},	--Punkt fr Goblin-Effekt 
		IncreaseGlobalCounter{ Name = "P101CounterGoblinPunkte", Step = 1},
...
OnOneTimeEvent
{
	...
	Actions = 
	{
		...
		Goto {X = 231, Y = 251, NpcId = 7758, Range = 0, WalkMode = Run, GotoMode = GotoForced}, --Goblin zurck in Pferch
		                                                           
		Goto {X = 232, Y = 234, NpcId = 6981, Range = 2, WalkMode = Run, GotoMode = GotoForced}, --Orks strmen das Spielfeld
...
OnOneTimeEvent
{
	...
	Actions = 
	{
		...
		Goto {X = 221, Y = 229, NpcId = 7758, Range = 0, WalkMode = Run, GotoMode = GotoForced}, --Goblins strmen das Spielfeld
